...
enum class Index
{
    ...
    cPUMismatch = 28,
    cPUThermalTrip = 29,
    bMCTimeUpdatedViaHost = 30,
    bMCTimeUpdatedManually = 31,
    bMCTimeUpdatedViaNTP = 32,  
    ...
    driveError = 38,
    eventLogCleared = 39,
    eventSubscriptionAdded = 40,
    eventSubscriptionRemoved = 41,
    eventSubscriptionUpdated = 42,
    fanInserted = 43,
    fanRedundancyLost = 44,
    fanRedundancyRegained = 45,
    fanRemoved = 46,
    firmwareActivationCompleted = 47,
    firmwareActivationFailed = 48,
    firmwareActivationStarted = 49,
    firmwareResiliencyError = 50,
    firmwareUpdateCompleted = 51,
    firmwareUpdateFailed = 52,
    firmwareUpdateStaged = 53,
    firmwareUpdateStarted = 54,
    generalFirmwareSecurityViolation = 55,
    iPMIWatchdog = 56,
    intelUPILinkWidthReducedToHalf = 57,
    intelUPILinkWidthReducedToQuarter = 58,
    invalidLoginAttempted = 59,
    invalidUpload = 60,
    inventoryAdded = 61,
    inventoryRemoved = 62,
    lanLost = 63,
    ...
    legacyPCIPERR = 65,
    legacyPCISERR = 66,
    mEAutoConfigFailed = 67,
    mEAutoConfigSuccess = 68,
    mEBootGuardHealthEvent = 69,
    mECpuDebugCapabilityDisabled = 70,
    mEDirectFlashUpdateRequested = 71,
    mEExceptionDuringShutdown = 72,
    mEFactoryResetError = 73,
    mEFactoryRestore = 74,
    mEFirmwareException = 75,
    mEFirmwarePanicReason = 76,
    mEFirmwareRecoveryReason = 77,
    mEFirmwareResiliencyError = 78,
    mEFlashEraseError = 79,
    mEFlashStateInformation = 80,
    mEFlashStateInformationWritingEnabled = 81,
    mEFlashVerificationError = 82,
    mEFlashWearOutWarning = 83,
    mEImageExecutionFailed = 84,
    mEInternalError = 85,
    mEManufacturingError = 86,
    mEMctpInterfaceError = 87,
    mEMultiPchModeMisconfig = 88,
    mEPeciOverDmiError = 89,
    mEPttHealthEvent = 90,
    mERecoveryGpioForced = 91,
    mERestrictedMode = 92,
    mESmbusLinkFailure = 93,
    mEUmaError = 94,
    mEUnsupportedFeature = 95,
    manufacturingModeEntered = 96,
    manufacturingModeExited = 97,
    memoryECCCorrectable = 98,
    memoryECCUncorrectable = 99,
    memoryParityCommandAndAddress = 100,
    memoryParityNotKnown = 101,
    memoryRASConfigurationDisabled = 102,
    memoryRASConfigurationEnabled = 103,
    memoryRASModeDisabled = 104,
    memoryRASModeEnabled = 105,
    memoryThermTrip = 106,
    mirroringRedundancyDegraded = 107,
    mirroringRedundancyFull = 108,
    nMIButtonPressed = 109,
    nMIDiagnosticInterrupt = 110,
    pCIeCorrectableAdvisoryNonFatal = 111,
    pCIeCorrectableBadDLLP = 112,
    pCIeCorrectableBadTLP = 113,
    pCIeCorrectableHeaderLogOverflow = 114,
    pCIeCorrectableInternal = 115,
    pCIeCorrectableLinkBWChanged = 116,
    pCIeCorrectableReceiverError = 117,
    pCIeCorrectableReplayNumRollover = 118,
    pCIeCorrectableReplayTimerTimeout = 119,
    pCIeCorrectableUnspecifiedAERError = 120,
    pCIeFatalACSViolation = 121,
    pCIeFatalAtomicEgressBlocked = 122,
    pCIeFatalCompleterAbort = 123,
    pCIeFatalCompletionTimeout = 124,
    pCIeFatalDataLinkLayerProtocol = 125,
    pCIeFatalECRCError = 126,
    pCIeFatalFlowControlProtocol = 127,
    pCIeFatalMCBlockedTLP = 128,
    pCIeFatalMalformedTLP = 129,
    pCIeFatalPoisonedTLP = 130,
    pCIeFatalReceivedErrNonFatalMessage = 131,
    pCIeFatalReceivedFatalMessageFromDownstream = 132,
    pCIeFatalReceiverBufferOverflow = 133,
    pCIeFatalSurpriseLinkDown = 134,
    pCIeFatalTLPPrefixBlocked = 135,
    pCIeFatalUncorrectableInternal = 136,
    pCIeFatalUnexpectedCompletion = 137,
    pCIeFatalUnspecifiedNonAERFatalError = 138,
    pCIeFatalUnsupportedRequest = 139,
    powerButtonLongPressed = 140,
    ...
    SensorProcessorPresence = 164,
    SensorWatchdog2 = 165,
    OSCriticalStop = 166,
    SensorSystemACPIPowerState = 167,
    SensorDeviceACPIPowerStateAssert = 168,
    SensorDeviceACPIPowerStateDeassert = 169,    
    resetButtonPressed = 170,
    sELEntryAdded = 171,
    securityBoot2ndFlashEnabled = 172,
    securityP2aBridgeEnabled = 173,
    securityUartPortDebugEnabled = 174,
    securityUserNonRootUidZeroAssigned = 175,
    securityUserNonRootUidZeroRemoved = 176,
    securityUserRootDisabled = 177,
    securityUserRootEnabled = 178,
    securityUserStrongHashAlgoRestored = 179,
    securityUserUnsupportedShellEnabled = 180,
    securityUserUnsupportedShellRemoved = 181,
    securityUserWeakHashAlgoEnabled = 182,
    ...
    ssbThermalTrip = 195,
    stateSensorNormal = 196,
    stateSensorWarning = 197,
    stateSensorCritical = 198,
    systemInterfaceDisabledProvisioned = 199,
    systemInterfaceUnprovisioned = 200,
    systemInterfaceWhitelistProvisioned = 201,
    systemPowerGoodFailed = 202,
    systemPowerLost = 203,
    systemPowerOffFailed = 204,
    systemPowerOnFailed = 205,
    triggerNumericWarning = 206,
    triggerNumericCritical = 207,
    triggerDiscreteOK = 208,
    triggerDiscreteWarning = 209,
    ...
    KVMConnected = 215,
    KVMDisconnected = 216,
    KVMSessionTimeout = 217,
    KVMSessionTerminated = 218,
    KVMRedirectionDisabled = 219,
    KVMAVRstart = 220,
    KVMAVRstop = 221,
    MediaMount = 222,
    MediaUnmount = 223,
    MediaRedirectionDisabled = 224,
    alert = 225,
    asyncError = 226,
};
} // namespace redfish::registries::openbmc
