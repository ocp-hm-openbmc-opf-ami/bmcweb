...
// Power
    ...
    asyncResp->res.jsonValue["Oem"]["AMI"]["@odata.type"] = json_util::odataType("AmiChassis");
    ...
    asyncResp->res.jsonValue["Oem"]["AMI"]["SensorThreshold"]["@odata.id"] =
        boost::urls::format("/redfish/v1/Chassis/{}/Sensors/Oem/Ami/Threshold",
                            chassisId);
    asyncResp->res.jsonValue["Oem"]["AMI"]["SensorThreshold"]["@odata.type"] = json_util::odataType("AmiSensor");
#endif
#ifndef ONETREE_PSM
